...
export default function Navbar()
{
    return(
       ...
       <nav className="bg-transparent border-gray-400">
        ...
        <h1 className="text-5xl px-3 py-3 text-stone-50  sm:text-slate-500">AS</h1>
        <div className=" text-sm md:text-3xl py-4 pr-28 text-stone-50  sm:text-1xl">
        <Link className="px-3 py-3" to='/'> Home</Link>
        <Link  className="px-3 py-3"to='/projects'>Projects</Link>
        <Link className="px-3 py-3"to='/about'>About</Link>
        </div>
        </ul>  
      </nav>
